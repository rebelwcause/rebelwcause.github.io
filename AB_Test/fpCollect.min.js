				...
				t = {
					...
					anyPointer: function() {
						for (var n = ["fine", "coarse", "none", "any"], t = 0; t < n.length; t++) {
							var r = n[t];
							if (window.matchMedia("( any-pointer" + ("any" !== r ? ": " + r : "") + " )").matches) return r
						}
						return e
					},
					anyHover: function() {
						for (var n = ["hover", "on-demand", "none", "any"], t = 0; t < n.length; t++) {
							var r = n[t];
							if (window.matchMedia("( any-hover" + ("any" !== r ? ": " + r : "") + " )").matches) return r
						}
						return e
					},
					appVersion: function() {
					...
					etsl: function() {
						return eval.toString().length + "; " + eval.toString()
					},
					screenDesc: function() {
						try {
					...
					audio: function() {
						return new Promise(function(n) {
							var t = function(e, n, t) {
									for (var r in n) "dopplerFactor" === r || "speedOfSound" === r || "currentTime" === r || "number" != typeof n[r] && "string" != typeof n[r] || (e[(t || "") + r] = n[r]);
									return e
								},
								r = void 0;
							try {
								var o = window.AudioContext || window.webkitAudioContext;
								if ("function" != typeof o) return n(e);
								var a = new o,
									i = a.createAnalyser();
								r = t({}, a, "ac-"), r = t(r, a.destination, "ac-"), r = t(r, a.listener, "ac-"), r = t(r, i, "an-")
							} catch (n) {
								r = e
							}
							try {
								...
								d.threshold && (d.threshold.value = -50), d.knee && (d.knee.value = 40), d.ratio && (d.ratio.value = 12), d.reduction && (d.reduction.value = -20), d.attack && (d.attack.value = 0), d.release && (d.release.value = .25), u.connect(d), d.connect(c.destination), u.start(0), c.startRendering(), c.oncomplete = function(e) {
									for (var t = 0, o = 4500; 5e3 > o; o++) t += Math.abs(e.renderedBuffer.getChannelData(0)[o]);
									return d.disconnect(), n({
										nt_vc_output: r,
										pxi_output: t
									})
								}
					...
					canvas: function() {
						...
						try {
							r.rect(0, 0, 10, 10), r.rect(2, 2, 6, 6), n.canvasWinding = r.isPointInPath(5, 5, "evenodd")
						} catch (t) {
							n.canvasWinding = e
						}
						try {
							r.textBaseline = "alphabetic", r.fillStyle = "#f60", r.fillRect(125, 1, 62, 20), r.fillStyle = "#069", r.font = "11pt no-real-font-123", r.fillText("Cwm fjordbank glyphs vext quiz, 😃", 2, 15), r.fillStyle = "rgba(102, 204, 0, 0.2)", r.font = "18pt Arial", r.fillText("Cwm fjordbank glyphs vext quiz, 😃", 4, 45), r.globalCompositeOperation = "multiply", r.fillStyle = "rgb(255,0,255)", r.beginPath(), r.arc(50, 50, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(), r.fillStyle = "rgb(0,255,255)", r.beginPath(), r.arc(100, 50, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(), r.fillStyle = "rgb(255,255,0)", r.beginPath(), r.arc(75, 100, 50, 0, 2 * Math.PI, !0), r.closePath(), r.fill(), r.fillStyle = "rgb(255,0,255)", r.arc(75, 75, 75, 0, 2 * Math.PI, !0), r.arc(75, 75, 25, 0, 2 * Math.PI, !0), r.fill("evenodd"), n.image = t.toDataURL()
						} catch (t) {
							n.image = e
						}
						return n
